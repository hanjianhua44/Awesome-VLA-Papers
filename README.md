...
- **DriveWorld-VLA: Unified Latent-Space World Modeling with VLA for AD** | 北京交通大学, 香港理工 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.06521)
  > 在潜空间统一世界模型与VLA规划，用世界模型潜在状态作为VLA决策状态，NAVSIM SOTA

- **DriveFine: Refining-Augmented Masked Diffusion VLA** | 华南理工, 大连理工 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.14577)
  > 掩码扩散VLA + 可插拔Block-MoE，生成/修正专家解耦，结合混合RL自纠错

- **HiST-VLA: Hierarchical Spatio-Temporal VLA for E2E AD** | 中科院自动化所 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.13329)
  > 层次化时空VLA，融合多尺度时空特征用于端到端驾驶感知预测规划

- **UniUGP: Unifying Understanding, Generation, and Planning for E2E AD** | 清华 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.09864)
...
- **Unleashing the Potential of Diffusion Models for E2E AD** | 华中科大 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.22801)
  > 系统性探索扩散模型在端到端自动驾驶规划中的范式

- **AlignDrive: Aligned Lateral-Longitudinal Planning for E2E AD** | 华为 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2601.01762)
...
- **From Representational Complementarity to Dual Systems (HybridDriveVLA)** | 大连理工, 理想汽车 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.10719)
  > VLM与纯视觉backbone互补，快慢双系统策略，VLM仅低置信时介入，吞吐量提升3.2x

- **ReCogDrive: Reinforced Cognitive Framework for E2E AD** | 大连理工 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2506.08052)
...
- **ZTRS: Zero-Imitation E2E AD with Trajectory Scoring** | Waymo, UT Austin | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2510.24108)
  > 零模仿学习，通过轨迹评分替代传统模仿实现端到端驾驶

- **F1: A VLA Bridging Understanding and Generation to Actions** | 中科院自动化所, 上海AI Lab | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2509.06951)
  > 统一视觉理解与生成能力的VLA，克服反应式策略的局限

- **DrivePI: Spatial-aware 4D MLLM for Unified AD** | 华为诺亚 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.12799)
...
- **Risk-Aware World Model Predictive Control for E2E AD** | 中山大学 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.23259)
  > 风险感知的世界模型预测控制，提升不确定环境泛化

- **DriveLaW: Unifying Planning and Video Generation in a Latent Driving World** | 大连理工 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.23421)
  > 潜空间统一规划与视频生成
...
- **VFMF: World Modeling by Forecasting Vision Foundation Model Features** | Oxford | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.11225)
  > 在视觉基础模型特征空间中预测未来而非像素

- **DiST-4D: Disentangled Spatiotemporal Diffusion for 4D Driving Scene Generation** | 清华, 鹏城实验室 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2503.15208)
  > 解耦空间时间的扩散+度量深度，4D驾驶场景生成

- **HybridWorldSim: Scalable High-fidelity Simulator for AD** | 华为 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2511.22187)
  > 混合式高保真自动驾驶仿真器

- **World Guidance: World Modeling in Condition Space for Action Generation** | 清华 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.22010)
  > 条件空间世界建模指导动作生成

- **Motus: A Unified Latent Action World Model** | 清华 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.13030)
  > 统一潜在动作世界模型，联合建模动作与环境动态

### Simulation & Data 仿真与数据

- **SimScale: Learning to Drive via Real-World Simulation at Scale** | 上海AI Lab | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2511.23369)
  > 真实数据大规模仿真框架，3D渲染+轨迹扰动覆盖安全关键状态

- **Are All Data Necessary? Efficient Data Pruning for AD Dataset** | 清华 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.19270)
  > 轨迹熵最大化高效裁剪大规模自动驾驶数据集

- **Driving with A Thousand Faces: Closed-Loop Personalized E2E AD Benchmark** | 清华 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.18757)
  > 首个闭环个性化端到端驾驶评估基准
...
- **WAM-Flow: Parallel Coarse-to-Fine Motion Planning via Discrete Flow Matching** | 上海交大 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.06112)
  > 并行粗到细运动规划，离散流匹配高效轨迹生成

- **TrajMoE: Scene-Adaptive Trajectory Planning with MoE and RL** | 清华 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.07135)
...
- **Safe-SDL: Safety Boundaries for AI-Driven Self-Driving Labs** | 苏州大学 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.15061)
...
- **DM0: Embodied-Native VLA towards Physical AI** | 地平线 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.14974)
  > 具身原生VLA，面向Physical AI的端到端设计

- **RynnBrain: Open Embodied Foundation Models** | RynnAI | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.14979)
  > 开放具身基础模型，统一多任务多模态

- **RynnVLA-002: A Unified VLA and World Model** | RynnAI, 浙大 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2511.17502)
  > 统一VLA与世界模型的双能力架构

- **ABot-M0: VLA Foundation Model with Action Manifold Learning** | 西安交大 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.11236)
  > 动作流形学习构建机器人操作VLA
...
- **BagelVLA: Long-Horizon Manipulation via Interleaved VLA Generation** | 清华, 上海AI Lab | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.09849)
  > 交错式VLA生成，增强长时域操作能力
...
- **ManualVLA: CoT Manual Generation and Robotic Manipulation** | 北大 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.02013)
  > 同时生成思维链操作手册和执行机器人操作

- **HALO: Unified VLA for Embodied Multimodal CoT Reasoning** | 上海交大 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.21157)
  > VLA + 多模态CoT推理，增强长时域和OOD场景

- **AsyncVLA: Asynchronous Flow Matching for VLA** | 清华 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2511.14148)
  > 异步流匹配，解耦视觉语言理解与动作生成频率

- **LDA-1B: Scaling Latent Dynamics Action Model** | 字节跳动 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.12215)
...
- **RoboMIND 2.0: Multimodal Bimanual Mobile Manipulation Dataset** | 北大 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.24653)
  > 多模态双臂移动操作数据集

- **GigaBrain-0.5M: VLA from World Model-Based RL** | GigaBrain Team | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.12099)
  > 基于世界模型RL训练的VLA
...
- **ActionCodec: What Makes for Good Action Tokenizers** | 清华, 复旦 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.15397)
...
- **NIAF: Neural Implicit Action Fields** | 西安交大 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2603.01766)
  > 动作预测重构为连续函数回归，MLLM层次频谱调制器生成无限分辨率轨迹

- **FASTer: Efficient Autoregressive VLA via Neural Action Tokenization** | 腾讯 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.04952)
  > 神经动作词元化加速自回归VLA

- **LatBot: Distilling Universal Latent Actions for VLA** | 微软亚研 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2511.23034)
  > 大规模操作视频蒸馏通用潜在动作表征

### World Models & Policy Co-learning 世界模型与策略协同

- **World-VLA-Loop: Closed-Loop Learning of Video World Model and VLA Policy** | NUS | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.06508)
  > 视频世界模型与VLA策略闭环协同学习

- **DreamDojo: Generalist Robot World Model from Human Videos** | UC San Diego, KAIST | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.06949)
  > 从大规模人类视频学习通用机器人世界模型

- **RISE: Self-Improving Robot Policy with Compositional World Model** | 上海AI Lab | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.11075)
  > 组合式世界模型驱动机器人策略自我进化

- **VLAW: Iterative Co-Improvement of VLA Policy and World Model** | Stanford | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.12063)
  > VLA策略与世界模型迭代协同提升

- **WoVR: World Models as Reliable Simulators for Post-Training VLA with RL** | 港中文 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.13977)
  > 世界模型作为可靠模拟器用于VLA后训练RL

- **NORA-1.5: VLA with World Model and Action-based Preference Rewards** | CMU | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2511.14659)
  > 世界模型+动作偏好奖励训练VLA
...
- **RoboScape-R: Unified Reward-Observation World Models for RL** | 人大 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.03556)
  > 统一奖励-观测世界模型，面向泛化机器人RL

### RL & Policy Optimization 强化学习与策略优化

- **SRPO: Self-Referential Policy Optimization for VLA** | 上海交大 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2511.15605)
  > 自参照策略优化，用自身预测做参考信号

- **πRL: Online RL Fine-tuning for Flow-based VLA** | UC Berkeley | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2510.25889)
  > 面向流匹配VLA的在线RL微调

- **Reinforcing Action Policies by Prophesying** ⭐ | 复旦 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2511.20633)
  > 通过预言（预测未来状态）强化动作策略

- **Alleviating Sparse Rewards in Flow-Based GRPO** | 浙大 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.06422)
  > 建模逐步和长期采样效应，缓解流式GRPO稀疏奖励

- **PhyCritic: Multimodal Critic Models for Physical AI** | UMD, NVIDIA | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.11124)
  > 多模态物理Critic，评估动作物理合理性

- **Beyond VLM-Based Rewards: Diffusion-Native Latent Reward Modeling** | 港大 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.11146)
  > 扩散原生潜在奖励建模

- **Unified RL and Imitation Learning for VLMs** | KAIST | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2510.19307)
  > 统一RL与模仿学习的VLM训练范式
...
- **IGen: Scalable Data Generation from Open-World Images** | 清华深圳 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.01773)
...
- **Scalable VLA Pretraining with Real-Life Human Activity Videos** | 微软亚研 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2510.21571)
  > 人类活动视频预训练VLA，扩展数据规模

- **TraceGen: World Modeling in 3D Trace Space** | NYU | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2511.21690)
  > 3D轨迹空间建模，跨具身视频学习操作

- **How Do VLAs Effectively Inherit from VLMs?** | 微软亚研 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2511.06619)
...
- **SAGE: Scalable Agentic 3D Scene Generation for Embodied AI** | NVIDIA | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.10116)
...
- **MoE3D: MoE meets Multi-Modal 3D Understanding** | 港中文, 上科大 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2511.22103)
...
- **Forging Spatial Intelligence: Roadmap** | NTU | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.24385)
  > 面向自主系统的多模态数据预训练空间智能路线图

- **SpatialTree: How Spatial Abilities Branch Out in MLLMs** | 北航 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.20617)
  > 空间能力层次评估：感知→推理→交互

- **4D-RGPT: Region-level 4D Understanding** | NVIDIA, NTU | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.17012)
  > 感知蒸馏实现区域级4D时空推理
...
- **PixelRefer: Unified Spatio-Temporal Object Referring** | 浙大 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2510.23603)
  > 任意粒度时空对象引用框架

- **Revisiting Multimodal Positional Encoding in VLMs** | 阿里巴巴 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2510.23095)
  > 系统分析VLM多模态位置编码设计
...
- **Chain-of-Visual-Thought: Teaching VLMs with Continuous Visual Tokens** | UC Berkeley | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2511.19418)
  > 连续视觉token视觉思维链，增强密集视觉感知

- **SwimBird: Switchable Reasoning Mode in Hybrid Autoregressive MLLMs** | 中科大 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.06040)
  > 按需切换语言/视觉推理模式
...
- **Unifying Perception and Action: Implicit Visual CoT** | 南京大学 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2511.19859)
...
- **LightFusion: Double Fusion for Unified Multimodal** | 字节跳动 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2510.22946)
  > 轻量双融合框架统一理解与生成
...
- **Efficient Training of Diffusion MoE: A Practical Recipe** | 字节跳动 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.01252)
  > 扩散MoE高效训练配方

- **MindGPT-4ov: Enhanced MLLM via Multi-Stage Post-Training** | 腾讯 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.02895)
  > 多阶段后训练增强多模态大模型

### Efficient Inference 高效推理与压缩

- **VLA-Perf: Demystifying VLA Inference Performance** | Stanford | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.18397)
  > 首个VLA推理性能分析基准工具

- **PSA: Pyramid Sparse Attention for Efficient Video** | Monash | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.04025)
  > 金字塔稀疏注意力，高效视频理解/生成

- **Blink: Dynamic Visual Token Resolution** | 中科院 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.10548)
  > 动态视觉token分辨率

- **ApET: Approximation-Error Guided Token Compression** | 中科院深圳 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.19870)
  > 近似误差引导token压缩

- **AstraNav-Memory: Contexts Compression for Long Memory** | 浙大 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.21627)
  > 长程记忆上下文压缩

- **Efficient Multi-Camera Tokenization with Triplanes** | NVIDIA, Stanford | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2506.12251)
  > 三平面高效多相机词元化

- **Towards Efficient Multi-Camera Encoding for E2E Driving** | NVIDIA | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2512.10947)
  > 高效多相机编码方案
...
- **PhyBlock: Physical Understanding via 3D Block Assembly** | CMU, 中山大学 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2506.08708)
  > 3D积木组装的渐进式物理理解基准

- **WorldArena: Unified Benchmark for Embodied World Models** | 人大 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.08971)
  > 统一评估具身世界模型感知与功能效用

### Surveys 综述

- **A Comprehensive Survey on World Models for Embodied AI** | A*STAR | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2510.16732)
- **A Survey on Efficient Vision-Language-Action Models** | 武大 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2510.24795)
- **Reliable and Responsible Foundation Models: A Comprehensive Survey** | 多机构 | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2602.08145)
- **Video Generation Models in Robotics** | Stanford | arXiv 2026 | [[Paper]](https://arxiv.org/abs/2601.07823)
- **Multimodal Spatial Reasoning in the Large Model Era: Survey** | 港大 | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2510.25760)
- **Real Deep Research for AI, Robotics and Beyond** | Wisconsin, Apple | arXiv 2025 | [[Paper]](https://arxiv.org/abs/2510.20809)
