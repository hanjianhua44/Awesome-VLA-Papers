...
> 🔍 扫描 cs.CV + cs.RO 共 **186** 篇，筛选出 **13** 篇与 VLA / 自动驾驶 / 机器人 / Agent 相关的工作
...
| 🦾 机器人操作 | 6 | Tsinghua, SJTU, Nanjing Univ, XJTU, HKU, SUSTech, JD, Tsinghua, PKU, ZJU |
...
### 🔥 #6｜A Systematic Post-Train Framework for Video Generation
...
### ⭐ #8｜DiscreteRTC: Discrete Diffusion Policies are Natural Asynchronous Executors
...
### ⭐ #9｜MotionBricks: Scalable Real-Time Motions with Modular Latent Generative Model and Smart Primitives
...
### ⭐ #10｜OmniVTG: A Large-Scale Dataset and Training Paradigm for Open-World Video Temporal Grounding
...
### ⭐ #11｜ViPO: Visual Preference Optimization at Scale
...
### ⭐ #12｜The Thinking Pixel: Recursive Sparse Reasoning in Multimodal Diffusion Latents
...
### ⭐ #13｜Prefill-Time Intervention for Mitigating Hallucination in Large Vision-Language Models
