...
> 🔍 扫描 cs.CV + cs.RO 共 **290** 篇，筛选出 **36** 篇与 VLA / 自动驾驶 / 机器人 / Agent 相关的工作

## 📊 今日概览

| 方向 | 数量 | 亮点 |
|------|------|------|
| 🤖 VLA 模型 | 4 | CUHK, Univ of Toronto, Xiaomi, HUST, Univ of Macau, Tsinghua, A*STAR |
| 🚗 自动驾驶 | 5 | SJTU, Fudan, CASIA, CUHK, WHU, CAS |
| 🦾 机器人操作 | 13 | Samsung, Georgia Tech, NTU, Tsinghua, PKU, BIT |
| 🌍 世界模型 | 4 | SJTU, Shanghai AI Lab, HKU, Stanford, CMU, UCSD, Harvard, UCSD, Tsinghua, SJTU |
...
### 🔥 #6｜ReinDriveGen: Reinforcement Post-Training for Out-of-Distribution Driving Scene Generation
...
### ⭐ #7｜Unifying UAV Cross-View Geo-Localization via 3D Geometric Perception
...
### ⭐ #8｜Efficient Equivariant Transformer for Self-Driving Agent Modeling
...
### ⭐ #9｜SECURE: Stable Early Collision Understanding via Robust Embeddings in Autonomous Driving
...
### 🔥 #11｜CompassAD: Intent-Driven 3D Affordance Grounding in Functionally Competing Objects
...
### 🔥 #12｜Lifting Unlabeled Internet-level Data for 3D Scene Understanding
...
### 🔥 #13｜A3R: Agentic Affordance Reasoning via Cross-Dimensional Evidence in 3D Gaussian Scenes
...
### 🔥 #14｜Cross-Modal Visuo-Tactile Object Perception
...
### 🔥 #15｜AURA: Multimodal Shared Autonomy for Real-World Urban Navigation
...
### ⭐ #16｜Bridging Large-Model Reasoning and Real-Time Control via Agentic Fast-Slow Planning
...
### ⭐ #17｜A ROS 2 Wrapper for Florence-2: Multi-Mode Local Vision-Language Inference for Robotic Systems
...
### ⭐ #18｜ReMoGen: Real-time Human Interaction-to-Reaction Generation via Modular Learning from Diverse Data
...
### ⭐ #19｜OpenGo: An OpenClaw-Based Robotic Dog with Real-Time Skill Switching
...
### ⭐ #20｜Bridging Discrete Planning and Continuous Execution for Redundant Robot
...
### ⭐ #21｜Realistic Lip Motion Generation Based on 3D Dynamic Viseme and Coarticulation Modeling for Human-Robot Interaction
...
### ⭐ #22｜SMASH: Mastering Scalable Whole-Body Skills for Humanoid Ping-Pong with Egocentric Vision
...
### 🔥 #23｜EgoSim: Egocentric World Simulator for Embodied Interaction Generation
...
### 🔥 #24｜World Action Verifier: Self-Improving World Models via Forward-Inverse Asymmetry
...
### ⭐ #25｜LatentUM: Unleashing the Potential of Interleaved Cross-Modal Reasoning via a Latent-Space Unified Model
...
### ⭐ #26｜Control-DINO: Feature Space Conditioning for Controllable Image-to-Video Diffusion
...
### ⭐ #27｜Captioning Daily Activity Images in Early Childhood Education: Benchmark and Algorithm
...
### ⭐ #28｜Dense Point-to-Mask Optimization with Reinforced Point Selection for Crowd Instance Segmentation
...
### 🔥 #29｜Are VLMs Lost Between Sky and Space? LinkS$^2$Bench for UAV-Satellite Dynamic Cross-View Spatial Intelligence
...
### ⭐ #30｜Enhancing Medical Visual Grounding via Knowledge-guided Spatial Prompts
...
### ⭐ #31｜LESV: Language Embedded Sparse Voxel Fusion for Open-Vocabulary 3D Scene Understanding
...
### 🔥 #32｜Sparse Spectral LoRA: Routed Experts for Medical VLMs
...
### 🔥 #34｜PDA: Text-Augmented Defense Framework for Robust Vision-Language Models against Adversarial Image Attacks
...
### ⭐ #35｜SDesc3D: Towards Layout-Aware 3D Indoor Scene Generation from Short Descriptions
...
### ⭐ #36｜Cross-Domain Vessel Segmentation via Latent Similarity Mining and Iterative Co-Optimization
