...
> 🔍 扫描 cs.CV + cs.RO 共 **310** 篇，筛选出 **41** 篇与 VLA / 自动驾驶 / 机器人 / Agent 相关的工作

## 📊 今日概览

| 方向 | 数量 | 亮点 |
|------|------|------|
| 🤖 VLA 模型 | 5 | CUHK, Univ of Toronto, BUAA, CASIA, CAS, BIT, Xiaomi, HUST, Univ of Macau |
| 🚗 自动驾驶 | 5 | SJTU, Fudan, CASIA, CUHK, WHU, CAS |
| 🦾 机器人操作 | 13 | Samsung, Georgia Tech, NTU, Tsinghua, PKU, BIT |
| 🌍 世界模型 | 6 | SJTU, Shanghai AI Lab, HKU, Stanford, CMU, UCSD, Harvard, Oxford, Univ of Toronto |
| 🎯 强化学习与策略优化 | 2 | CASIA, HIT, HKU, CityU HK |
| 👁️ 空间感知与 3D 理解 | 3 | SYSU, A*STAR, Huawei |
| ⚡ 高效架构与推理加速 | 4 | Alibaba, CASIA, CAS, Southeast Univ, CMU |
...
**Qiyao Zhang, Shuhua Zheng, Jianli Sun 等 (9 位作者)** |  `BUAA, CASIA, CAS, BIT`

📎 [2604.02241](https://arxiv.org/abs/2604.02241) | `cs.CV cs.RO`

> Embodied visual tracking is crucial for Unmanned Aerial Vehicles (UAVs) executing complex real-world tasks. In dynamic urban scenarios with complex semantic requirements, Vision-Language-Action (VLA) models show great promise due to their cross-modal fusion and continuous action generation capabilities. Furthermore, to address temporal feature redundancy and the lack of spatial geometric priors in existing VLA models, we propose an improved VLA tracking model, UAV-Track VLA. Built upon the $π_{0.5}$ architecture, our model introduces a temporal compression net to efficiently capture inter-frame dynamics
>
> **关键技术：** 流匹配 / VLA / 零样本
...
### 🔥 #6｜Bench2Drive-VL: Benchmarks for Closed-Loop Autonomous Driving with Vision-Language Models
...
### 🔥 #7｜ReinDriveGen: Reinforcement Post-Training for Out-of-Distribution Driving Scene Generation
...
### ⭐ #8｜Unifying UAV Cross-View Geo-Localization via 3D Geometric Perception

**Haoyuan Li, Wen Yang, Fang Xu 等 (7 位作者)** |  `WHU, CAS`

📎 [2604.01747](https://arxiv.org/abs/2604.01747) | `cs.CV`

> Cross-view geo-localization for Unmanned Aerial Vehicles (UAVs) operating in GNSS-denied environments remains challenging due to the severe geometric discrepancy between oblique UAV imagery and orthogonal satellite maps. Most existing methods address this problem through a decoupled pipeline of place retrieval and pose estimation, implicitly treating perspective distortion as appearance noise rather than an explicit geometric transformation. In this work, we propose a geometry-aware UAV geo-localization framework that explicitly models the 3D scene geometry to unify coarse place recognition and fine-grained pose estimation within a single inference pipeline
>
> **关键技术：** Transformer

---

### ⭐ #9｜Efficient Equivariant Transformer for Self-Driving Agent Modeling
...
### ⭐ #10｜SECURE: Stable Early Collision Understanding via Robust Embeddings in Autonomous Driving
...
### 🔥 #11｜BAT: Balancing Agility and Stability via Online Policy Switching for Long-Horizon Whole-Body Humanoid Control
...
### 🔥 #12｜CompassAD: Intent-Driven 3D Affordance Grounding in Functionally Competing Objects
...
### 🔥 #13｜Lifting Unlabeled Internet-level Data for 3D Scene Understanding
...
### 🔥 #14｜A3R: Agentic Affordance Reasoning via Cross-Dimensional Evidence in 3D Gaussian Scenes
...
### 🔥 #16｜AURA: Multimodal Shared Autonomy for Real-World Urban Navigation
...
### ⭐ #17｜Bridging Large-Model Reasoning and Real-Time Control via Agentic Fast-Slow Planning
...
### ⭐ #18｜A ROS 2 Wrapper for Florence-2: Multi-Mode Local Vision-Language Inference for Robotic Systems
...
### ⭐ #19｜ReMoGen: Real-time Human Interaction-to-Reaction Generation via Modular Learning from Diverse Data
...
### ⭐ #20｜OpenGo: An OpenClaw-Based Robotic Dog with Real-Time Skill Switching
...
### ⭐ #21｜Bridging Discrete Planning and Continuous Execution for Redundant Robot
...
### ⭐ #22｜Realistic Lip Motion Generation Based on 3D Dynamic Viseme and Coarticulation Modeling for Human-Robot Interaction
...
### ⭐ #23｜SMASH: Mastering Scalable Whole-Body Skills for Humanoid Ping-Pong with Egocentric Vision
...
### 🔥 #24｜EgoSim: Egocentric World Simulator for Embodied Interaction Generation
...
### 🔥 #25｜World Action Verifier: Self-Improving World Models via Forward-Inverse Asymmetry
...
**Alexander Pondaven, Ziyi Wu, Igor Gilitschenski 等 (7 位作者)** |  `Oxford, Univ of Toronto`

📎 [2604.02330](https://arxiv.org/abs/2604.02330) | `cs.CV cs.AI cs.LG`

> Recent advances in video diffusion have enabled the development of "world models" capable of simulating interactive environments. However, these models are largely restricted to single-agent settings, failing to control multiple agents simultaneously in a scene. In this work, we tackle a fundamental issue of action binding in existing video diffusion models, which struggle to associate specific actions with their corresponding subjects. For this purpose, we propose ActionParty, an action controllable multi-subject world model for generative video games. It introduces subject state tokens, i.e. latent variables that persistently capture the state of each subject in the scene
>
> **关键技术：** 扩散模型 / 世界模型

---

### ⭐ #27｜Omni123: Exploring 3D Native Foundation Models with Limited 3D Data by Unifying Text to 2D and 3D Generation

**Chongjie Ye, Cheng Cao, Chuanyu Pan 等 (7 位作者)** |  `CUHK`

📎 [2604.02289](https://arxiv.org/abs/2604.02289) | `cs.CV cs.AI`
...
### ⭐ #30｜Captioning Daily Activity Images in Early Childhood Education: Benchmark and Algorithm
...
### ⭐ #31｜Dense Point-to-Mask Optimization with Reinforced Point Selection for Crowd Instance Segmentation
...
### 🔥 #32｜Are VLMs Lost Between Sky and Space? LinkS$^2$Bench for UAV-Satellite Dynamic Cross-View Spatial Intelligence
...
### ⭐ #33｜Enhancing Medical Visual Grounding via Knowledge-guided Spatial Prompts
...
### ⭐ #34｜LESV: Language Embedded Sparse Voxel Fusion for Open-Vocabulary 3D Scene Understanding
...
### 🔥 #35｜Sparse Spectral LoRA: Routed Experts for Medical VLMs
...
### ⭐ #36｜PLUME: Latent Reasoning Based Universal Multimodal Embedding
...
**Jona Ruthardt, Manu Gaur, Deva Ramanan 等 (5 位作者)** |  `CMU`

📎 [2604.02327](https://arxiv.org/abs/2604.02327) | `cs.CV cs.AI`
...
### ⭐ #38｜A Simple Baseline for Streaming Video Understanding

**Yujiao Shen, Shulin Tian, Jingkang Yang 等 (4 位作者)** |  `NTU`

📎 [2604.02317](https://arxiv.org/abs/2604.02317) | `cs.CV`

> Recent streaming video understanding methods increasingly rely on complex memory mechanisms to handle long video streams. Despite its simplicity, SimpleStream delivers consistently strong performance. With only 4 recent frames, it reaches 67.7% average accuracy on OVO-Bench and 80.59% on StreamingBench. Controlled ablations further show that the value of longer context is backbone-dependent rather than uniformly increasing with model scale, and reveal a consistent perception-memory trade-off: adding more historical context can improve recall, but often weakens real-time perception

---

## 📎 相关工作（3 篇）

### 🔥 #39｜PDA: Text-Augmented Defense Framework for Robust Vision-Language Models against Adversarial Image Attacks
...
### ⭐ #40｜SDesc3D: Towards Layout-Aware 3D Indoor Scene Generation from Short Descriptions
...
### ⭐ #41｜Cross-Domain Vessel Segmentation via Latent Similarity Mining and Iterative Co-Optimization
